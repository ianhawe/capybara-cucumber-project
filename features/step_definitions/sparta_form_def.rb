...
Given("I fill in the form") do
  ...
  @sparta_webpage.sparta_registration_form.fill_in_address_line_one('21 Teignmouth Road')
  ...
  @sparta_webpage.sparta_registration_form.fill_in_postcode('SW2 1BU')
  @sparta_webpage.sparta_registration_form.fill_in_email_address('bob@spartaglobal.com')
  @sparta_webpage.sparta_registration_form.fill_in_skills('Java, boxing, talking')
